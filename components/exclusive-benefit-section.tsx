...
import { BadgeCheck, Gift, AlertTriangle } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl">
        <div className="relative overflow-hidden rounded-2xl border border-[#ffff00]/30 bg-white/5 p-8 sm:p-12">
          {/* Background glow */}
          <div
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="w-full space-y-4">
              <div className="flex items-start gap-3 rounded-lg border border-white/20 bg-white/5 p-4 text-left">
                <BadgeCheck className="mt-0.5 h-5 w-5 shrink-0" style={{ color: "#ffff00" }} />
                <span className="text-base text-white">
                  {"Credencial personalizada exclusiva da edi\u00E7\u00E3o 1 ano"}
                </span>
              </div>
              <div className="flex items-start gap-3 rounded-lg border border-white/20 bg-white/5 p-4 text-left">
            ...
            <p className="mt-8 text-sm text-white/60">
              {"Garanta seu ingresso antes que os 50 primeiros acabem!"}
            </p>
          </div>
        </div>
      </div>
